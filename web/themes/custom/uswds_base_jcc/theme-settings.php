 ...
 */
function uswds_base_jcc_form_system_theme_settings_alter(&$form, FormStateInterface &$form_state, $form_id = NULL) {
  ...
  $form['header_style_fieldset'] = [
    ...
    'uswds_header_hide_site_name' => [
      '#type' => 'checkbox',
      '#title' => t('Hide site name?'),
      '#default_value' => theme_get_setting('uswds_header_hide_site_name'),
    ],
    'uswds_header_hide_universal_nav' => [
      '#type' => 'checkbox',
      '#title' => t('Hide universal navigation?'),
      '#default_value' => theme_get_setting('uswds_header_hide_universal_nav'),
    ],
  ];
